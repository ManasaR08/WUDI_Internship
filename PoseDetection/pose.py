...
while True:
    ...
    frameWidth = img_rgb.shape[1]
    frameHeight = img_rgb.shape[0]
    ...
    inpBlob = cv2.dnn.blobFromImage(img_rgb, 1.0 / 255, (inWidth, inHeight),
    ...
    for part in range(nPoints):
        ...
        probMap = cv2.resize(probMap, (img_rgb.shape[1], img_rgb.shape[0]))
